...
export function useSchedule(creditBalance = 0) {
    const [schedule, setSchedule] = useState(null);
    const [weeklyQty, setWeeklyQty] = useState(DEFAULT_WEEKLY_QTY);
    const [deliveryTime, setDeliveryTime] = useState('07:00');
    const [notifyReconfigure, setNotifyReconfigure] = useState(false);
