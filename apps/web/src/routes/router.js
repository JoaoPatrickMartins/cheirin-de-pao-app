...
export const router = createBrowserRouter([
    {
        ...
        children: [
            {
                path: '/',
                element: _jsx(SplashScreen, {}),
            },
            {
                path: '/login',
                lazy: () => import('../pages/auth/LoginScreen').then((m) => ({
                    Component: m.LoginScreen,
                })),
            },
            {
                path: '/register',
                lazy: () => import('../pages/auth/OnboardingScreen').then((m) => ({
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: 'creditos',
                        lazy: () => import('../pages/client/CombosScreen').then((m) => ({
                            Component: m.CombosScreen,
                        })),
                    },
                    {
                        path: 'agenda',
                        lazy: () => import('../pages/client/ScheduleScreen').then((m) => ({
                            Component: m.ScheduleScreen,
                        })),
                    },
                    {
                        path: 'agenda/pedido-unico',
                        lazy: () => import('../pages/client/SingleScreen').then((m) => ({
                    ...
                    },
                    {
                        ...
                        lazy: () => import('../pages/client/CardPaymentScreen').then((m) => ({
                            Component: m.CardPaymentScreen,
                        })),
                    },
                    {
                        path: 'creditos/sucesso',
                        lazy: () => import('../pages/client/PurchasedScreen').then((m) => ({
                            Component: m.PurchasedScreen,
                        })),
                    },
                    {
                        path: 'creditos/extrato',
                        lazy: () => import('../pages/client/CreditHistoryScreen').then((m) => ({
                            Component: m.CreditHistoryScreen,
                        })),
                    },
                    {
                        path: 'creditos/recorrente',
                        lazy: () => import('../pages/client/AutoBuyScreen').then((m) => ({
            ...
            },
            {
                ...
                children: [
                    {
                        path: 'couriers/new',
                        lazy: () => import('../pages/admin/CourierRegisterScreen').then((m) => ({
