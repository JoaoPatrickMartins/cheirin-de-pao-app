...
vi.mock('../../../contexts/NotifContext', () => ({
    ...
    NotifContext: { Provider: ({ children }) => children },
}));
...
function mockApiForNotifs(notifs) {
...
describe('NotificationsScreen [ACOMP-04, ACOMP-05]', () => {
    ...
    it('renderiza AppBar "Notificações"', async () => {
        render(_jsx(MemoryRouter, { children: _jsx(NotificationsScreen, {}) }));
        await waitFor(() => {
