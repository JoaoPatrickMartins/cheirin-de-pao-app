          ...
          200: {
            ...
            items: {
              ...
              properties: {
                ...
                projectedBreads: { type: 'integer', description: 'Pães previstos pela agenda SEM risco, ainda não materializados. O previsto em risco fica fora e vai em riskBreads.' },
                ...
                riskBreads: { type: 'integer', description: 'Pães previstos em risco — NÃO somam em nenhum total; só contam quando confirmarem.' },
                ...
                bySlot: {
                  type: 'array',
                  description: 'Quebra por slot/turno: pães contáveis (pagos + previstos sem risco), paradas e itens do mercadinho.',
                  items: {
                    type: 'object',
                    properties: {
                      slotId: { type: 'string' },
                      ...
                      atRisk: { type: 'integer', description: 'Pães previstos em risco do turno — fora de breads.' },
                    },
                  },
                },
              },
              ...
              slots: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    generated: { type: 'boolean' },
                    totalBreads: { type: 'integer', description: 'Pães contáveis do turno (pagos + previstos sem risco).' },
                    totalItems: { type: 'integer', description: 'Itens do mercadinho do turno — métrica paralela aos pães.' },
                    riskBreads: { type: 'integer', description: 'Pães previstos em risco — fora de totalBreads.' },
                  },
                },
              },
            },
  ...
  fastify.get(
    '/admin/supplier-orders/upcoming-days',
    {
      ...
      schema: {
        ...
        description:
          'Lista os próximos N dias (default 7, BRT) com seus turnos: pães confirmados, previstos sem risco, previstos em risco (fora dos totais), entregas, clientes em risco, se a compra já foi gerada e se o corte já passou. Restrito a ADMIN.',
        security: [{ bearerAuth: [] }],
        querystring: {
          type: 'object',
          properties: {
                    ...
                    slots: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          projectedBreads: { type: 'integer', description: 'Previstos pela agenda SEM risco (contexto).' },
                          deliveries: { type: 'integer', description: 'Paradas do turno (pão + Cestinha do mesmo cliente = 1).' },
                          riskCount: { type: 'integer' },
                          riskBreads: { type: 'integer', description: 'Pães previstos em risco — fora de breads e de projectedBreads.' },
                          generated: { type: 'boolean' },
        ...
        response: {
          200: {
            ...
            properties: {
              ...
              name: { type: 'string' },
              totalBreads: { type: 'integer', description: 'Pães contáveis (pagos + previstos SEM risco), incluindo o pão da Cestinha. O previsto em risco fica fora.' },
              materializedBreads: { type: 'integer', description: 'Pães já pagos (pedidos de pão + pão da Cestinha).' },
              projectedBreads: { type: 'integer', description: 'Pães previstos pela agenda SEM risco, ainda não materializados.' },
              ...
              riskBreads: { type: 'integer', description: 'Pães previstos em risco — NÃO somam em totalBreads nem em projectedBreads.' },
              ...
              deliveries: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    quantity: { type: 'integer', description: 'Pães contáveis da parada (pago + previsto SEM risco). Parada em risco vem 0 aqui — o número está em breadAtRisk.' },
                    slotId: { type: 'string' },
                    slotLabel: { type: 'string' },
                    ...
                    breadAtRisk: { type: 'integer', description: 'Pães previstos em risco desta parada — fora de quantity e de todo total.' },
                    marketItems: {
                      type: 'array',
